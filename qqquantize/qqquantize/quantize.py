...
from qqquantize.qqquantize.observers.minmaxchannelsobserver import MovingAverageMinMaxActChannelsObserver
        ...
        for name, mod in model.named_modules():
            ...
            if 'm.' in name:
                mod.qconfig.activation = FakeQuantize.with_args(
                                        observer=MovingAverageMinMaxActChannelsObserver,
